...
function categories_list() {
    return array('سلامت جسم', 'خواب و استراحت', 'سلامت روان', 'تمرکز و ذهن', 'یادگیری', 'رشد فردی', 'روابط', 'زوج درمانی', 'خانواده', 'ذهن‌آگاهی', 'مراقبت از خود', 'بهره‌وری', 'سبک زندگی');
}
...
function stickers_list() {
    return array('🏃', '💧', '🚶', '🍎', '🌙', '⏰', '🧘', '🌬️', '📓', '🎯', '📵', '📝', '📚', '🛠️', '⭐', '💑', '🙏', '☕', '📞', '🏠', '✨', '🌸', '🛁', '🎨', '✅', '🔥', '📅', '📖', '📗', '📘', '🥗', '🍬', '🤸', '💭', '🌿', '💬', '🎧', '🖥️', '🧴', '🌇', '🔍', '🌈', '🪞', '🧭', '💗', '🗣️', '👂', '🤲', '🗨️', '🧯', '⚖️', '🩹', '🔐', '🧱', '🔁', '🧩', '💝', '💘', '🤝', '🏁', '💰', '🛡️', '📱', '💞', '💚', '☁️', '🧺', '🌨️', '🕊️', '🏡', '👤', '🌀', '💪', '💍', '💐', '📒', '🍷', '🔗', '📋');
}
