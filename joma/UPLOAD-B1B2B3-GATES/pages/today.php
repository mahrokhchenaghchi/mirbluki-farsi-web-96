...
<?php $todayCap = jalali_today(); ?>
<?php if (strcmp($b['start'], $todayCap) > 0) { ?>
<p class="lede" style="max-width:360px">ثبت عملکرد برای این دوره هنوز شروع نشده است.</p>
<?php } else { ?>
<form method="get" class="card" style="max-width:360px">
  ...
  <select name="date" onchange="this.form.submit()">
    <?php for ($d = 1; $d <= $b['days']; $d++) {
        ...
        if (strcmp($ds, $todayCap) > 0) break; // (B3) روزهای آینده انتخاب نمی‌شوند
