...
t('water: day without status is final (legacy safe)', $st0['status'] === 'none' && $st0['effective_final'] === true);
t('water: is_final true for a legacy record', joma_water_is_final($uid, $today) === true);
