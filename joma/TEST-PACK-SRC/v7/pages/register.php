      ...
      <div class="field-row" style="margin-top:10px">
        <div>
          ...
          <div style="position:relative">
            <input type="password" name="password" id="reg-pass" autocomplete="new-password" required minlength="6">
        ...
        <div><label>تکرار رمز عبور</label><input type="password" name="confirm" autocomplete="new-password" required minlength="6"></div>
      </div>
