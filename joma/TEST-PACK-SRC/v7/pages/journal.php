          ...
          <details class="gl" style="margin-top:8px">
            ...
            <div class="glossary" style="margin-top:8px">
              <table>
                ...
                <tr><th>قاعده و نسخه</th><td><?php
                  $__rule_names = array(
                      'weekday_best' => 'قاعدهٔ بهترین روز هفته',
                      'mood_activity_relation' => 'قاعدهٔ رابطهٔ حال و کارها',
                      'streak' => 'قاعدهٔ پیوستگی ثبت',
                      'coverage_most' => 'قاعدهٔ پایدارترین فعالیت',
                      'water_final' => 'قاعدهٔ ثبت نهایی آب',
                  );
                  echo e(isset($__rule_names[$evi['ruleId']]) ? $__rule_names[$evi['ruleId']] : 'قاعدهٔ ثبت‌های تو');
                ?> · نسخهٔ <?php echo e($evi['ruleVersion']); ?></td></tr>
