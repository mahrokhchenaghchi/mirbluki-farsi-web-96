...
$u = current_user();
// این صفحه نوار بالای خودش را دارد (طبق سند: فقط لوگو + دو دکمه)؛ پس نوار پوسته را نمی‌گیرد.
joma_header('جوما — برنامه‌ریزی، اجرا، فهم', array(), array('public' => 1, 'no_top' => 1));
?>
<div class="land">
  ...
  <section class="hero">
    <div>
      ...
      <div class="joma-msg" style="margin-top:14px">
        <span class="av owl-float"><?php echo joma_v2_icon('owl-hi', 'ic lg'); ?></span>
        <span><b>جوما</b><p class="lede">سلام! من جغد راهنمای تو‌ام؛ یک تخم هم برایت دارم که با قدم‌هایت جوانه می‌زند.</p></span>
      </div>
    ...
    <div class="phone">
      <div class="prow" style="border-bottom:1px solid var(--card-brd);padding-bottom:9px">
        ...
        <?php if (function_exists('joma_v2_time_sticker')) echo joma_v2_time_sticker(null, 32); ?>
      </div>
  ...
  <section class="calm" style="margin-top:18px">
    ...
    <div class="card" style="background:var(--card)">
      ...
      <p class="tiny">این تصویر، نمای کلی برنامه است؛ خانهٔ تو با ثبت‌های خودت پر می‌شود.</p>
    </div>
  </section>
