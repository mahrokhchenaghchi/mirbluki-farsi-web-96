...
<div class="grid grid-2">
  <section class="card" style="text-align:center;background:linear-gradient(160deg,var(--lav-soft),var(--sky-soft))">
    <div style="display:grid;place-items:center"><?php echo joma_v2_pet_svg($j['stage'], $j['state'], 168); ?></div>
    <div class="row" style="justify-content:center;margin-top:6px">
      <span class="chip g"><?php echo e($stage); ?></span>
      <span class="chip"><?php echo e($state); ?></span>
      <?php if (!empty($j['pet_name'])) { ?><span class="chip s"><?php echo e($j['pet_name']); ?></span><?php } ?>
    </div>
    <p class="lede" style="margin-top:8px"><?php echo e(isset($state_note[$j['state']]) ? $state_note[$j['state']] : ''); ?></p>
