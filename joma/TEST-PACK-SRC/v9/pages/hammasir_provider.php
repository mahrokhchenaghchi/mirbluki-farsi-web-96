...
<section class="hd-sec" style="animation-delay:.2s;">
  <div class="row" style="justify-content:space-between;align-items:baseline">
    ...
    <span class="chip"><?php echo fa_num((int) $hammasir_p_data['counts']['all']); ?> مراجع</span>
  </div>
  <div class="cc-filter">
    <?php foreach (joma_provider_filter_defs() as $hammasir_p_fk => $hammasir_p_flbl) {
        ...
        echo '<a class="' . (($hammasir_p_filter === $hammasir_p_fk) ? 'on' : '') . '" href="' . e($hammasir_p_furl) . '">'
           . e($hammasir_p_flbl) . ' <span class="n">' . fa_num($hammasir_p_fc) . '</span></a>';
    } ?>
  </div>
  ...
  <div class="cc-grid">
    ...
    ?>
      <article class="client-card" data-state="<?php echo e($hammasir_p_st['key']); ?>">
        <div class="cc-top">
        ...
        <?php if ($hammasir_p_st['chick'] !== '') { ?>
          <div class="cc-chick">
            <span class="chick" aria-hidden="true"><?php echo joma_provider_chick_svg($hammasir_p_st['chick'], 46); ?></span>
            <div class="cc-state"><b><?php echo e($hammasir_p_st['label']); ?></b><small><?php echo e($hammasir_p_st['text']); ?></small></div>
          </div>
        <?php } else { ?>
          <div class="cc-state"><b><?php echo e($hammasir_p_st['label']); ?></b><small><?php echo e($hammasir_p_st['text']); ?></small></div>
        <?php } ?>
