            ...
            <div class="cstep">
              ...
              <div class="cstep-body">
                ...
                <details style="margin-top:10px">
                  <summary class="tiny">کد دعوت دارم</summary>
                  <div class="code-soon">کد دعوت را همراهت برایت می‌فرستد. این مسیر به‌زودی فعال می‌شود؛ همین حالا می‌توانی از فهرست بالا همراه انتخاب کنی.</div>
                </details>
              </div>
            </div>
          </section>
