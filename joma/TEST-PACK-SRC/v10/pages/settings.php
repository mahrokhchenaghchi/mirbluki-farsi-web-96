...
<form class="card" method="post">
  ...
  <?php /* (F3 — v10) نمونهٔ زندهٔ چگالی نمایش: دو کارت کنار هم، تغییر همان‌لحظه.
           بدون JS هم کار می‌کند: انتخاب داخل فرم ذخیره می‌شود. */ ?>
  <p class="tiny">چگالی نمایش را انتخاب کن؛ همین حالا روی همهٔ کارت‌های همین صفحه اعمال می‌شود.</p>
  <div class="dens-pick" id="dens-pick">
    <label class="dens-opt<?php echo empty($prefs['compact_cards']) ? ' on' : ''; ?>" data-dens="relaxed">
      <input type="radio" name="compact" value="0" <?php echo empty($prefs['compact_cards']) ? 'checked' : ''; ?>>
      <span class="dens-prev">
        <span class="dprev-card"><b>کارت نمونه</b><small>با توضیح و فاصلهٔ راحت</small></span>
        <span class="dprev-card"><b>کارت نمونه</b><small>متن کامل دیده می‌شود</small></span>
      </span>
      <b>راحت</b><small>فاصلهٔ بیشتر، توضیح کامل زیر هر کارت</small>
    </label>
    <label class="dens-opt dens-compact<?php echo !empty($prefs['compact_cards']) ? ' on' : ''; ?>" data-dens="compact">
      <input type="radio" name="compact" value="1" <?php echo !empty($prefs['compact_cards']) ? 'checked' : ''; ?>>
      <span class="dens-prev">
        <span class="dprev-card"><b>کارت نمونه</b><small>با توضیح و فاصلهٔ راحت</small></span>
        <span class="dprev-card"><b>کارت نمونه</b><small>متن کامل دیده می‌شود</small></span>
      </span>
      <b>فشرده</b><small>فاصلهٔ کمتر، کارت‌های جمع‌وجورتر</small>
    </label>
  </div>
