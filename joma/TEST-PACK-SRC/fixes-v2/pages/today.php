...
<section class="card water-card" id="water-card">
  <?php echo csrf_field(); ?>
  <span style="display:none" data-pa="<?php echo e($waterPa['id']); ?>" data-date="<?php echo e($date); ?>"
  data-target="<?php echo (int) $glasses; ?>" data-value="<?php echo (int) $filled; ?>"
  data-draft="<?php echo $isDraft ? '1' : '0'; ?>" data-final="<?php echo $isFinal ? '1' : '0'; ?>"></span>
  <div class="row" style="justify-content:space-between">
    ...
    <div class="wrow">
      <button type="button" class="snd-btn" data-water-sound="1" aria-pressed="true">
        <?php echo joma_v2_icon('i-vol', 'ic'); ?><span>صدای لیوان</span>
      </button>
  ...
  <?php } else { ?>
    ...
    <p class="tiny">روی لیوان بزن تا همان تعداد ثبت شود؛ روی آخرین لیوانِ پر بزن تا یکی کم شود. تا «ثبت نهایی» نشود، پیش‌نویس است و در سنجه‌ها شمرده نمی‌شود.</p>
  <?php } ?>
  <?php if ($isDraft) { ?>
...
<div class="mob-sheet" id="breath-sheet"><div class="inner" style="text-align:center">
  ...
  <div style="display:grid;place-items:center;padding:18px 0">
    <div id="breath-circle" style="width:180px;height:180px;border-radius:50%;background:var(--brand-softer);
  ...
  <p class="lede" id="breath-hint">دکمه را بزن؛ سه دور نفس آرام. راهنمای صوتی با هر مرحله پخش می‌شود.</p>
