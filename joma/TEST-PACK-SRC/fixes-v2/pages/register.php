...
<div class="card auth-card" style="max-width:640px">
  ...
  <form method="post" action="<?php echo e(joma_url('index.php?p=register')); ?>" id="reg-wizard" data-start="<?php echo (int) $errStep; ?>">
    ...
    <div class="wdots" aria-label="مراحل ثبت‌نام">
      ...
      <button type="button" class="wdot" data-step="3"><i class="num">۳</i><span>حساب</span></button>
      <button type="button" class="wdot" data-step="4"><i class="num">۴</i><span>تماس و تأیید</span></button>
    </div>
    <p class="wcount tiny" data-wcount>قدم ۱ از ۴</p>

    <!-- گام ۱ — معرفی -->
    <section class="wstep scene-sky" data-step="1">
      <div class="whead">
        <span class="wvisual"><?php echo joma_v2_icon('owl-hi', 'ic lg'); ?></span>
        <div><b class="wtitle">خودت را معرفی کن</b><p class="tiny">با همان نامی که دوست داری در خانه صدایت کنیم.</p></div>
      </div>
    ...
    <section class="wstep scene-gold" data-step="2">
      <div class="whead">
        ...
        <div><b class="wtitle">شغلت چیست؟</b><p class="tiny">فقط برای هم‌سوکردن تجربهٔ تو؛ در هیچ گزارشی منتشر نمی‌شود.</p></div>
      </div>
      ...
      <p class="tiny">نقش حساب همیشه «کاربری» ساخته می‌شود؛ ارتقای نقش فقط از مسیر پشتیبانی است.</p>
      <div class="wrow" style="justify-content:space-between;margin-top:12px">
    ...
    <section class="wstep scene-rose" data-step="3">
      <div class="whead">
        ...
        <div><b class="wtitle">حساب کاربری‌ات</b><p class="tiny">نام کاربری، چیزی است که با آن وارد می‌شوی.</p></div>
      </div>
      ...
      <div class="field-row" style="margin-top:2px">
        ...
        <div><label>تکرار رمز عبور</label><input type="password" name="confirm" autocomplete="new-password" required></div>
      </div>
