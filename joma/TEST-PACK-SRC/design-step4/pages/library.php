...
?>
<?php joma_v2_pagehead('کتابخانه', 'کتابخانهٔ فعالیت‌ها', 'فعالیت‌های آمادهٔ جوما؛ هر کدام هدف و واحد خودش را دارد. آن‌چه با زندگی‌ات جور است را به برنامهٔ ماه اضافه کن.'); ?>
