...
<?php } elseif ($g === 'couple' || $g === 'schema') {
  ...
  <div class="grid grid-3">
    ...
    learn_hub_card(joma_url('index.php?p=learn&g=couple'), 'i-heart', 'زوج‌درمانی', 'تمرین‌های رابطه؛ هر کدام یک جلسهٔ کوتاه نوشتاری.');
    learn_hub_card(joma_url('index.php?p=learn&g=schema'), 'i-book', 'طرح‌واره‌درمانی', 'تکنیک‌های هسته و طرح‌واره‌های انتخابی.');
    ?>
  </div>
<?php } ?>
<?php joma_footer(); ?>
